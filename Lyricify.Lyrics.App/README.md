...
| Redirect mismatch error | Ensure `http://localhost:766/callback` is added **exactly** as a Redirect URI in your Spotify dashboard |
...
| 回调地址不匹配错误 | 确保 Spotify 控制台中已**精确**添加 `http://localhost:766/callback` 为回传地址 |
